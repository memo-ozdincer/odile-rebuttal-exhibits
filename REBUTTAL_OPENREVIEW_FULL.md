...
The jam never produces the attacker action: 0/5805 distinct WASP paraphrases, trace-validated ([trace]({ANON}/traces_pdf/trace_secalign_cracked_vs_odile.pdf)). It is attack-specific, not a blanket breakdown: on the benign version of WASP, ODILE still completes the legitimate action (e.g. 93% at Llama-3.3-70B).
