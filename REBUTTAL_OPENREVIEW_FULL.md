...
- **vs Meta-SecAlign** (Chen et al. 2026), head-to-head at Llama-3.3-70B. On **AgentDojo**, ODILE holds 0.01% ASR vs Meta-SecAlign's 2.11% at 1x cost, while Meta-SecAlign retrains the full model and carries higher benign utility (62.6% vs 51.5%); they sit at different points on the security-utility frontier ([70B table]({ANON}/tab_pareto_70b.pdf)). On **InjecAgent**, ODILE holds ASR-all ≤ 0.15% on every backbone vs Meta-SecAlign's 0.2–2.6% ([InjecAgent table]({ANON}/t_injecagent_full.pdf)).
