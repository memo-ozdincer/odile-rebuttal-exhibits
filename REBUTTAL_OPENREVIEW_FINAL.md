...
**vs Meta-SecAlign** (Chen et al. 2026), head-to-head at Llama-3.3-70B. On **AgentDojo**, ODILE holds 0.01% ASR vs Meta-SecAlign's 2.11% (≈200x lower) at 1x cost, while Meta-SecAlign retrains the full model and carries higher benign utility (62.6% vs 51.5%); the two sit at different points on the security-utility frontier ([70B table](https://anonymous.4open.science/r/odile-anon-exhibits-82D6/tab_pareto_70b.pdf)). On **InjecAgent**, ODILE holds ASR-all ≤ 0.20% across all four families vs Meta-SecAlign's 0.2–2.6% ([InjecAgent table](https://anonymous.4open.science/r/odile-anon-exhibits-82D6/t_injecagent_full.pdf)).
...
**Broader field:** the [cross-benchmark comparator](https://anonymous.4open.science/r/odile-anon-exhibits-82D6/tab_comparator_8b.pdf) places ODILE against ReasAlign (Li et al. 2026) on all five benchmarks at once (ReasAlign matches ASR at ~13pp benign cost).
